    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: #333;">
          ...
          <p><strong>Jenis Tugas:</strong> ${order.taskType === 'daily' ? 'Tugas Harian' : 'Tugas Akhir / Capstone'}</p>
          <p><strong>Durasi:</strong> ${order.duration} hari</p>
          <p><strong>Total Pembayaran:</strong> <span style="font-size: 18px; font-weight: bold; color: #000;">Rp ${(order.totalPrice || 0).toLocaleString('id-ID')}</span></p>
